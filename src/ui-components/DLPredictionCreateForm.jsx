...
export default function DLPredictionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOpportunityID(initialValues.OpportunityID);
    setOpportunity(initialValues.Opportunity);
    setProductGroup(initialValues.ProductGroup);
    setBookingStatus(initialValues.BookingStatus);
    ...
    setSamePEinSAP(initialValues.SamePEinSAP);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new DLPrediction(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "DLPredictionCreateForm")}
    >
      <TextField
        label="Owner"
        isRequired={false}
